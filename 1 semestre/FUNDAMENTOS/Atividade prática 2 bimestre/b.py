...
def main():
    ...
    print()
    while True:
        base = ler_valor("Digite o valor da base do retângulo (ou 'sair' para encerrar): ")
        if base is None:
            print("Encerrando o programa.")
            break
        print()
        altura = ler_valor("Digite o valor da altura do retângulo (ou 'sair' para encerrar): ")
        if altura is None:
            print("Encerrando o programa.")
            break
        print()
        ...
        print("-" * 40)
        print()
        resposta = input("Deseja calcular a área de outro retângulo? (s/n): ").strip().lower()
